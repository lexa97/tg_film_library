...
- Реакция на команду `/start` (с группами и без)
- Обработка присланного контакта (различные случаи)
- Поиск фильма по тексту

Все внешние зависимости (Telegram API, БД, TMDB API) мокируются в тестах.
